...
const Contact = () => {
  return (
    <div className='main-container  max-w-5xl m-auto mt-8 height'>
      <div className='contact-section gap-10 flex w-full'>
        ...
        <div className='right border shadow-md flex flex-col gap-6 p-8 rounded-md text-xs'>
          ...
          <button className='bg-yellow-500 p-2 rounded-md text-white font-semibold shadow-lg'>Send Message</button>
        </div>
      </div>
    </div>
  );
